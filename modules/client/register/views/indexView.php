    ...
    <div class="w-full w-[500px] te">
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="pass" name="pass"  type="password" placeholder="******************">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="re_pass" name="re_pass" type="password"  placeholder="******************">
                <p class="text-red-500 text-xs italic">Mật khẩu không khớp</p>
            </div>
