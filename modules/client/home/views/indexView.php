    ...
    <section class="mb-[33px] ">
        ...
        <div class="slideshow-container">
            <div class="mySlides fade">
                <img src="public/images/banner.png" class="w-full h-[500px]">
            </div>
            <div class="mySlides fade">
                <img src="public/images/thichsua.jpg" class="w-full h-[500px]">
            </div>
            <div class="mySlides fade">
                <img src="public/images/banner3.jpg" class="w-full h-[500px]">
            </div>
