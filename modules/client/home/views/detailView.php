...
<main>    
            <section class="mt-[37px] mb-[64px] bg-white rounded-[30px] flex ">
                <img src="img/anh1.png" alt="" class="py-[20px] mx-[56px]">
                <div class="flex">
                    <div class="mt-[15px] ">
                        <h2 class="text-[28px] mb-[26px]">Sữa bột XO số 2,3 dành cho bé tăng cân</h2>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-[15px] mb-[28px]">
                                <p
                                    class="border-2 border-solid border-[#666666] w-[72px] h-[26px] text-[10px] text-center pt-[3px]">
                                    100g</p>
                                <p
                                    class="border-2 border-solid border-[#666666] w-[72px] h-[26px] text-[10px] text-center pt-[3px]">
                                    300g</p>
                        ...
                        <div class="flex mb-[41px]">
                            <button type="button" onClick='decreaseCount(event, this)'
                                class="rounded-l-lg border-[2px] border-solid border-black w-[23px] h-[33px]"><span
                                    class="down">-</span></button>
                            <input class="border-[2px] border-solid border-black text-center w-[80px]" type="text" value="1"
                                readonly="true">
                            <button type="button" onClick='increaseCount(event, this)'
                                class="rounded-r-lg border-[2px] border-solid border-black w-[23px]"><span
                                    class="up">+</span></button>
                        </div>
                        <form action="" method="post" class="flex">
                            <button
                                class="font-bold text-[15px] bg-[#FF5722] text-white w-[174px] h-[56px] text-center rounded-[7px] mr-[15px]">MUA
                                NGAY</button>
                            <button
                                class="bg-orange-200 border-[#FF5722] border-solid rounded-[7px] w-[259px] h-[56px] flex text-[15px]">
                                <img src="img/cart2.png" alt="" class="mt-[18px] ml-[30px] mr-[13px]">
            ...
            <section class="bg-white rounded-[30px]">
                ...
                <form action="" class="ml-[67px] pb-[43px] mb-[51px]">
                    <input type="text" name="" placeholder="Viết nội dung đánh giá ở đây..."
                        class="border-[1px] border-[#E2E2E2] w-[967px] pl-[20px] pt-[20px] pb-[150px] mb-[36px]">
